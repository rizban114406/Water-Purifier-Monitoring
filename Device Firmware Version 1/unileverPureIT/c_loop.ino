void loop() {
  ...
  if (batteryStatus > volatageThreshold && dataSendingFlag == true && gsmStatus == 1 && confStatus == 1) 
  {
...
//    sendLastValues(dataToSend,"103.9.185.218/unileverpureit/public/api/device/v1/addInSecond");
  ...
  else if (batteryStatus > volatageThreshold && sendNotiStat == true && gsmStatus == 1 && confStatus == 1)
  {
